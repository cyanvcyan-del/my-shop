...
export default function GroupingCard({ title, icon }: GroupingCardProps) {
  return (
    <section className="group mx-auto bg-mainT w-25 h-25 max-sm:w-28 max-sm:h-27 md:w-35 md:h-35 max-md:w-35 max-md:h-35 xl:w-45 xl:h-45 rounded-[40px] grid place-items-center transition-colors duration-400 hover:bg-[#111] active:bg-[#111] cursor-pointer">
