export default function ProductCard({ image, title, price }) {
  return (
    <div className=" group w-37 h-55 sm:w-37 sm:h-55 md:w-56 md:h-71 bg-mainT  hover:bg-gray-200 hover:scale-105 duration-300 rounded-br-[40px] rounded-bl-[40px] rounded-tl-[104px] rounded-tr-[104px] p-2.5 ">
