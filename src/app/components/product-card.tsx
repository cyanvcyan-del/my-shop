...
//     >
//       <div className="w-32 md:w-48 bg-mainT cursor-pointer">
...
//           <button
//             type="button"
//             className="w-16 h-6 md:w-18 md:h-8 bg-mainblack rounded-2xl text-white text-xs md:text-sm font-medium ml-1 mt-2 md:mt-3"
//           >
//             {price}
//           </button>
