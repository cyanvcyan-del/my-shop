export default function Hero() {
    return(
        <div className="flex flex-col lg:flex-row w-[92%] max-w-[70rem] mx-auto mt-4 md:mt-7 p-6 md:p-10 rounded-[40px] bg-[#F8F9FA] shadow-[0_10px_30px_rgba(0,0,0,0.04)] relative">
            
            {/* Badge 20% OFF */}
            <div className="absolute top-6 right-6 md:top-8 md:right-8 text-right font-extrabold text-[#1a1a1a] text-2xl md:text-[2.5rem] leading-none tracking-tighter">
                20%<br />OFF
            </div>

            {/* Left Section: Text Content */}
            <div className="flex flex-col justify-center items-start flex-1 gap-3 md:gap-4 pl-0 lg:pl-6 py-8 lg:py-0 z-10">
                <h1 className="text-[2.8rem] md:text-[4rem] lg:text-[4.5rem] font-black text-[#1a1a1a] tracking-tight leading-[1.1]">
                    Japanese beef
                </h1>
